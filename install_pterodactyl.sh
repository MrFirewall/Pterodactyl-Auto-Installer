...
check_dependencies() {
  # Nach der Installation der Basis-Pakete prüfen wir, ob curl und gpg vorhanden sind, bevor wir sie verwenden
...
# Clean up potentially problematic files first
clean_apt_sources
...
install_common_dependencies
check_dependencies # Prüft, ob curl und gpg nach install_common_dependencies funktionieren

install_php_and_redis_repo # Sollte nun sauber laufen
